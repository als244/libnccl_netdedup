...
#define MAX_COMMS_NET_DEDUP_SOCKET_DEV 1024

#define TO_PRINT_FINGERPRINT_CACHE 0

#define TO_PRINT_INTERCEPT_INFO 0
#define TO_PRINT_CAPTURE_STATS 1
#define TO_PRINT_ALL_RECV_HANDLE_INFO 0 
#define TO_PRINT_FINGERPRINT_INFO 0
#define TO_PRINT_ALL 0
#define TO_PRINT_OOB_SENDS 1
#define TO_PRINT_OOB_RECVS 1
#define TO_PRINT_SKIPS 0
#define TO_PRINT_RECOVERS 0
#define TO_PRINT_OUTBOUND_TIMEOUTS 0
...
#define MAX_FDS 1024
#define BASIC_SKIPPED_BUFFER_SIZE 1024

#define FINGERPRINT_CACHE_PATH "/libnetdedup"

#define FINGERPRINT_CACHE_NUM_BYTES (1UL << 31)

#define FINGERPRINT_CACHE_PAGE_SIZE (1UL << 12)
#define FINGERPRINT_CACHE_NUM_PAGES (FINGERPRINT_CACHE_NUM_BYTES / FINGERPRINT_CACHE_PAGE_SIZE)

#define FINGERPRINT_TABLE_SIZE (1UL << 20)
...
#define FINGERPRINT_CHECK_OTHER_INITIATE_TIMEOUT_MICROS 10
#define FINGERPRINT_CONFIRM_APPROVED_TIMEOUT_MICROS 3000
#define FINGERPRINT_CLEAR_TO_SEND_TIMEOUT_MICROS 100000
